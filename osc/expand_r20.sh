#!/bin/bash
#SBATCH --job-name=fia_expand_r20
#SBATCH --account=PUOM0008
#SBATCH --time=02:30:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=4 --mem=160G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_exp_r20_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_exp_r20_%j.err
...
r18_dirs <- c(
  paste0("ME_", today, "_rcp45_hadgem2_wear_r20"),
  paste0("ME_", today, "_rcp45_hadgem2_wear_econ_r20"),
  paste0("ME_", today, "_rcp85_hadgem2_wear_r20"),
  paste0("ME_", today, "_rcp85_hadgem2_wear_econ_r20")
)
