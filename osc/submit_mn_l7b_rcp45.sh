#!/bin/bash
#SBATCH --job-name=fia_mn_l7b
#SBATCH --account=PUOM0008
#SBATCH --time=20:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=200G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_mn_l7b_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_mn_l7b_%j.err
...
#
# Tag: rcp45_wear_l7b (production run #1 from p-series).
# Expected wall: ~6-10 hours (MN ~63k plots vs ME ~6k).
# Output: output/MN_<DATE>_rcp45_wear_l7b/
# =============================================================================
