#!/bin/bash
#SBATCH --job-name=fia_wa_p3_85
#SBATCH --account=PUOM0008
#SBATCH --time=12:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=180G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_wa_p3_85_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_wa_p3_85_%j.err
...
# --tag rcp85_wear_p3. WA state_constants row: dT 2.0/3.8, fire 0.060/cyc.
# Tag: rcp85_wear_p3
# Output: output/WA_<DATE>_rcp85_wear_p3/
