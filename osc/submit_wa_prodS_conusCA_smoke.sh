#!/bin/bash
#SBATCH --job-name=wa_prodSca
#SBATCH --account=PUOM0008
#SBATCH --time=04:00:00
#SBATCH --cpus-per-task=40 --mem=180G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_prodSca_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_prodSca_%j.err
...
Rscript run_projection.R --state WA --n_sims 20 --cycles 15 \
  --cores ${SLURM_CPUS_PER_TASK} --scenario_set harvest \
  --tag rcp45_wear_prodS_conusCA \
...
echo "WA productivity smoke done $(date)"
