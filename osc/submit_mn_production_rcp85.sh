#!/bin/bash
#SBATCH --job-name=fia_mn_p1_85
#SBATCH --account=PUOM0008
#SBATCH --time=20:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=200G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_mn_p1_85_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_mn_p1_85_%j.err
...
# --tag rcp85_wear_p1. See submit_mn_production.sh for flag rationale.
#
...
# Tag: rcp85_wear_p1
# Output: output/MN_<DATE>_rcp85_wear_p1/
# =============================================================================
