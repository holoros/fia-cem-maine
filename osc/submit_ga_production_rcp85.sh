#!/bin/bash
#SBATCH --job-name=fia_ga_p1_85
#SBATCH --account=PUOM0008
#SBATCH --time=16:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=200G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_p1_85_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_p1_85_%j.err
...
# --tag rcp85_wear_p1. GA state_constants row: dT 2.2/4.0, fire 0.040/cyc.
# Tag: rcp85_wear_p1
# Output: output/GA_<DATE>_rcp85_wear_p1/
