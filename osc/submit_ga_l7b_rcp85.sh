#!/bin/bash
#SBATCH --job-name=fia_ga_l7b_85
#SBATCH --account=PUOM0008
#SBATCH --time=16:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=200G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_l7b_85_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_l7b_85_%j.err
