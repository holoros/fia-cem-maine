#!/bin/bash
#SBATCH --job-name=fia_wa_p1
#SBATCH --account=PUOM0008
#SBATCH --time=12:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=180G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_wa_p1_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_wa_p1_%j.err
