#!/bin/bash
#SBATCH --job-name=fia_ga_hm
#SBATCH --account=PUOM0008
#SBATCH --time=24:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=400G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_hm_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_hm_%j.err
