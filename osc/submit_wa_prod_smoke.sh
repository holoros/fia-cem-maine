#!/bin/bash
#SBATCH --job-name=wa_prodsmk
#SBATCH --account=PUOM0008
#SBATCH --time=04:00:00
#SBATCH --cpus-per-task=40 --mem=180G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_prodsmk_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_prodsmk_%j.err
