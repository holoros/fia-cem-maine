#!/bin/bash
#SBATCH --job-name=wa_conusCA_prod
#SBATCH --account=PUOM0008
#SBATCH --time=12:00:00
#SBATCH --cpus-per-task=40 --mem=360G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_conusCA_prod_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/wa_conusCA_prod_%j.err
