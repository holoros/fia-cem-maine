#!/bin/bash
#SBATCH --job-name=fia_ga_p3lite_85
#SBATCH --account=PUOM0008
#SBATCH --time=16:00:00
#SBATCH --nodes=1 --ntasks-per-node=1 --cpus-per-task=48 --mem=200G
#SBATCH --output=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_p3lite_85_%j.out
#SBATCH --error=/users/PUOM0008/crsfaaron/fia_cem_projections/logs/fia_ga_p3lite_85_%j.err
...
# --tag rcp85_wear_p3lite. GA state_constants row: dT 2.2/4.0, fire 0.040/cyc.
# Tag: rcp85_wear_p3lite
# Output: output/GA_<DATE>_rcp85_wear_p3lite/
...
Rscript run_projection.R --state GA --n_sims 50 --cycles 15 \
