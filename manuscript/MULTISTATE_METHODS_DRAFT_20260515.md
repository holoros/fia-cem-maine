...
**GA +10 percent over mechanism (under investigation).** The original hypothesis was plantation versus natural stand donor mixing. A 17 May 2026 GA donor pool diagnostic refuted this directional claim: GA subjects are 43 percent plantation-indicative pine forest types (FORTYPCD 141, 142, 161, 165 to 168); the donor pool (FL, SC, AL, TN) is only 30 percent plantation-indicative. GA has more plantation types than its donor pool, not less. Candidate alternative mechanisms include growth-ratio multiplicative effect on GA's high-productivity baseline, carbon-to-volume ratio over-estimation in plantation forest types, disturbance schedule mis-specification, and age-class saturation behavior for young plantation stands. The Cardinal FIA donor extracts for the southern cohort lack STDORGCD entirely, so STDORGCD-stratified matching cannot be tested without additional FIA DataMart pulls.
...
- GA +10 percent over bias: mechanism under investigation after the 17 May 2026 diagnostic refuted the plantation/natural donor mixing hypothesis. Candidate mechanisms: growth-ratio multiplicative effect on high-productivity baseline, plantation C:V ratio over-estimation, disturbance schedule mis-specification, age-class saturation under-application. Cardinal FIA donor extracts for southern cohort lack STDORGCD; full investigation requires additional DataMart pulls.
